# Release Notes for Lotus 1.8.1

## Highlights

Automated release 1.8.1 with comprehensive testing and fixes.
...
### Binary Downloads
Download pre-built binaries from the [releases page](https://github.com/j-alexander3375/Lotus/releases/tag/1.8.1).
