# Release Notes for Lotus 1.7.1

## Highlights

Automated release 1.7.1 with comprehensive testing and fixes.
...
### Binary Downloads
Download pre-built binaries from the [releases page](https://github.com/j-alexander3375/Lotus/releases/tag/1.7.1).
